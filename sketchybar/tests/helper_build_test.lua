...
local make_specs = {
	...
	{ id = "aerospace_watch", dir = "helpers/event_providers/aerospace_watch", target = "bin/aerospace_watch",
		sources = { "aerospace_watch.swift", "../sketchybar_mach.c", "../sketchybar.h", "makefile", "../../swift.mk", "../../helper_compile.sh" } },
	{ id = "docker_watch", dir = "helpers/event_providers/docker_watch", target = "bin/docker_watch",
		sources = { "docker_watch.swift", "../sketchybar_mach.c", "../sketchybar.h", "makefile", "../../swift.mk", "../../helper_compile.sh" } },
	{ id = "input_method_watch", dir = "helpers/event_providers/input_method", target = "bin/input_method_watch",
		sources = { "input_method_watch.swift", "../sketchybar_mach.c", "../sketchybar.h", "makefile", "../../swift.mk", "../../helper_compile.sh" } },
	{ id = "media_watch", dir = "helpers/event_providers/media_watch", target = "bin/media_watch",
		sources = { "media_watch.swift", "../sketchybar_mach.c", "../sketchybar.h", "makefile", "../../swift.mk", "../../helper_compile.sh" } },
	{ id = "sys_watch", dir = "helpers/event_providers/sys_watch", target = "bin/sys_watch",
		sources = { "sys_watch.swift", "../sketchybar_mach.c", "../sketchybar.h", "makefile", "../../swift.mk", "../../helper_compile.sh" } },
